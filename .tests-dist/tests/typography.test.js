...
run("applyNbspToText: does not modify email and URL substrings", () => {
    assert.equal(applyNbspToText("email me at olgabis.design@gmail.com"), "email me at olgabis.design@gmail.com");
    assert.equal(applyNbspToText("visit https://example.com/a test"), "visit https://example.com/a test");
});
run("applyNbspToText: does not duplicate existing NBSP", () => {
    assert.equal(applyNbspToText("I\u00A0am a developer"), "I\u00A0am a\u00A0developer");
});
