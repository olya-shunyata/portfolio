  ...
  home: {
    ...
    projects: {
      ...
      cards: [
        ...
        {
          title: ["SaaS conversion", "platform"],
          description:
            "Website optimization platform with heatmaps, A/B testing, and analytics to help teams improve performance.",
          tags: [
            "SaaS",
            "Product design",
            "UX/UI design",
  ...
  projects: {
    vet: {
      ...
      nav: {
        ...
        nextTitle: "SaaS conversion platform",
      ...
      overview: {
        columns: [
          ...
          {
            title: "Contribution",
            description: [["I led the redesign of the inpatient workflow, focusing on improving identification accuracy and treatment tracking within the veterinary clinic."]],
            selected: true,
          },
        ],
      },
    ...
    saas: {
      ...
      pageTitle: "SaaS conversion optimization platform",
      navHeading: "See more",
      nav: {
        previousTitle: "Veterinary clinic software",
      ...
      test: {
        heading: {
          title: "Design",
          description:
            "The stylistic solution relies on the interplay of contrasting typography and vibrant accents.",
        },
      ...
      productPage: {
        header: {
          title: "( Product page )",
          description: [
            "I underscored the pivotal functionality that propels the service, bringing users' attention to the potential and benefits associated with the use of detailed analytics, A/B testing, and hitmaps.",
          ],
        },
      ...
      illustrations: {
        ...
        headers: {
          model: {
            ...
            description: ["Created in Cinema 4D and rendered using Arnold Renderer"],
          },
          prototype: {
            title: "( Prototyping )",
          },
